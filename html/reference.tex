...
or image size.
~\\When optional arguments 'pos\_x' and 'pos\_y' are specified, the window is moved to
...
~\\\textbf{Arguments: } 
{\small \texttt{\_size$>$0, \_R,\_G,\_B}}\\~\\
Input a 2d RGBA colored ball sprite.
~\\~\\\textbf{Default values}: {\small \texttt{'size=64', 'R=255', 'G=R'} and \texttt{'B=R'.}}
