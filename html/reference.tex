...
~\\Exact pre-defined sizes are '13','23' and '53'. Any other size is interpolated from an exact size.
...
{\footnotesize \textbf{Example 393~:} \texttt{image.jpg -text\_outline "Hi there!",10,10,53,3}}
\end{center}
