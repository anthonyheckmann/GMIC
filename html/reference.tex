...
~\\Specified filenames should have no spaces in it.
...
[gmic]-0./__help/document_gmic/*repeat/*local/*if/*if/*if/*if/_document_gmic_example_latex/*if/*local/foo/ Input 3d torus, with radii (100,40) and subdivisions (24,12).
[gmic]-1./__help/document_gmic/../_document_gmic_example_latex/*if/*local/foo/ Disable double-sided mode for 3d rendering.
[gmic]-1./__help/document_gmic/../_document_gmic_example_latex/*if/*local/foo/ Reverse orientation of 3d object [0].terminate called after throwing an instance of 'std::bad_alloc'
  what():  std::bad_alloc
