...
{\footnotesize \textbf{Example 407~:} \texttt{image.jpg -luminance -resize2dy 40 -threshold 50\% -* 255 -pointcloud3d -color3d[-1] 255,255,255 -cubes3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 474~:} \texttt{image.jpg --apply\_parallel\_overlap "-smooth 500,0,1",16}}
\end{center}
...
{\footnotesize \textbf{Example 475~:} \texttt{image.jpg -repeat 10 -blur 1 -if \{1==1\} -continue -endif -deform 10 -done}}
\end{center}
...
{\footnotesize \textbf{Example 476~:} \texttt{image.jpg -repeat 10 -blur 1 -if \{1==1\} -break -endif -deform 10 -done}}
\end{center}
...
{\footnotesize \textbf{Example 477~:} \texttt{image.jpg -luminance i=\{ia+2\} -do -set 255,\{?(100)\}\%,\{?(100)\}\% -while \{ia$<$\$i\}}}
\end{center}
...
{\footnotesize \textbf{Example 478~:} \texttt{image.jpg -if \{ia$<$64\} -add 50\% -elif \{ia$<$128\} -add 25\% -elif \{ia$<$192\} -sub 25\% -else -sub 50\% -endif -cut 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 479~:} \texttt{image.jpg -local[] 300,300,1,3 -rand[0] 0,255 -blur 4 -sharpen 1000 -endlocal}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def480.jpg}\\
{\footnotesize \textbf{Example 480~:} \texttt{image.jpg --local -repeat 3 -deform 20 -done -endlocal}}
\end{center}
...
{\footnotesize \textbf{Example 481~:} \texttt{image.jpg --local -blur -3 -onfail -mirror x -endlocal}}
\end{center}
...
{\footnotesize \textbf{Example 482~:} \texttt{image.jpg [0] -parallel "-blur[0] 3","-mirror[1] c"}}
\end{center}
...
{\footnotesize \textbf{Example 483~:} \texttt{image.jpg -split y -repeat @\% -shift[\$$>$] \$$<$,0,0,0,2 -done -append y}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def484.jpg}\\
{\footnotesize \textbf{Example 484~:} \texttt{image.jpg -mode3d 2 -repeat 4 -imagecube3d -rotate3d 1,1,0,40 -snapshot3d 400,1.4 -done}}
\end{center}
...
{\footnotesize \textbf{Example 485~:} \texttt{image.jpg -command "foo : u0=Dark u1=Bright -status \$\{u\{ia$>$=128\}\}" -text\_outline @\{-foo\},2,2,24,2,1,255}}
\end{center}
...
{\footnotesize \textbf{Example 486~:} \texttt{image.jpg -array 3,2,2}}
\end{center}
...
{\footnotesize \textbf{Example 487~:} \texttt{image.jpg -array\_fade 3,2}}
\end{center}
...
{\footnotesize \textbf{Example 488~:} \texttt{image.jpg -array\_mirror 2}}
\end{center}
...
{\footnotesize \textbf{Example 489~:} \texttt{image.jpg --array\_random 8,8,15,10}}
\end{center}
...
{\footnotesize \textbf{Example 490~:} \texttt{image.jpg -frame\_blur 3,30,8,10\%}}
\end{center}
...
{\footnotesize \textbf{Example 491~:} \texttt{image.jpg -frame\_cube ,}}
\end{center}
...
{\footnotesize \textbf{Example 492~:} \texttt{image.jpg -frame\_fuzzy 20}}
\end{center}
...
{\footnotesize \textbf{Example 493~:} \texttt{image.jpg -frame\_painting ,}}
\end{center}
...
{\footnotesize \textbf{Example 494~:} \texttt{image.jpg -frame\_pattern 8}}
\end{center}
...
{\footnotesize \textbf{Example 495~:} \texttt{image.jpg -frame\_round 10}}
\end{center}
...
{\footnotesize \textbf{Example 496~:} \texttt{image.jpg -frame\_x 20,255,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 497~:} \texttt{image.jpg -frame\_xy 1,1,0 -frame\_xy 20,10,255,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 498~:} \texttt{image.jpg -frame\_y 20,255,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 499~:} \texttt{image.jpg -imagegrid 16}}
\end{center}
...
{\footnotesize \textbf{Example 500~:} \texttt{image.jpg --linearize\_tiles 16}}
\end{center}
...
{\footnotesize \textbf{Example 501~:} \texttt{image.jpg --quadratize\_tiles 16}}
\end{center}
...
{\footnotesize \textbf{Example 502~:} \texttt{image.jpg -to\_rgba -rotate\_tiles 10,8 -drop\_shadow 10,10 -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 503~:} \texttt{image.jpg --shift\_tiles 8,8,10}}
\end{center}
...
{\footnotesize \textbf{Example 504~:} \texttt{image.jpg --taquin 8}}
\end{center}
...
{\footnotesize \textbf{Example 505~:} \texttt{image.jpg --tunnel 20}}
\end{center}
\section{Artistic}
...
{\footnotesize \textbf{Example 506~:} \texttt{image.jpg --boxfitting ,}}
\end{center}
...
{\footnotesize \textbf{Example 507~:} \texttt{image.jpg --cartoon 3,80,15}}
\end{center}
...
{\footnotesize \textbf{Example 508~:} \texttt{image.jpg --circlism ,}}
\end{center}
...
{\footnotesize \textbf{Example 509~:} \texttt{image.jpg --color\_ellipses ,,0.15}}
\end{center}
...
{\footnotesize \textbf{Example 510~:} \texttt{image.jpg --cubism ,}}
\end{center}
...
{\footnotesize \textbf{Example 511~:} \texttt{image.jpg --dotsbw , --blend shapeaverage0}}
\end{center}
...
{\footnotesize \textbf{Example 512~:} \texttt{image.jpg --draw\_whirl ,}}
\end{center}
...
{\footnotesize \textbf{Example 513~:} \texttt{image.jpg --drawing ,}}
\end{center}
...
{\footnotesize \textbf{Example 514~:} \texttt{image.jpg -drop\_shadow 10,20,5,0.5 -expand\_xy 20,0 -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 515~:} \texttt{image.jpg --ellipsionism ,}}
\end{center}
...
{\footnotesize \textbf{Example 516~:} \texttt{image.jpg -fire\_edges ,}}
\end{center}
...
{\footnotesize \textbf{Example 517~:} \texttt{image.jpg --glow ,}}
\end{center}
...
{\footnotesize \textbf{Example 518~:} \texttt{image.jpg --halftone ,}}
\end{center}
...
{\footnotesize \textbf{Example 519~:} \texttt{image.jpg --hardsketchbw 200,70,0.1,10 -median[-1] 2 --local -reverse -blur[-1] 3 -blend overlay -endl}}
\end{center}
...
{\footnotesize \textbf{Example 520~:} \texttt{image.jpg --hearts ,}}
\end{center}
...
{\footnotesize \textbf{Example 521~:} \texttt{image.jpg --houghsketchbw ,}}
\end{center}
...
{\footnotesize \textbf{Example 522~:} \texttt{image.jpg --lightrays , -+ -c 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 523~:} \texttt{image.jpg --blur 2 -light\_relief[-1] 0.3,4,0.1,0}}
\end{center}
...
{\footnotesize \textbf{Example 524~:} \texttt{image.jpg --mosaic ,}}
\end{center}
...
{\footnotesize \textbf{Example 525~:} \texttt{image.jpg --old\_photo}}
\end{center}
...
{\footnotesize \textbf{Example 526~:} \texttt{image.jpg --pencilbw ,}}
\end{center}
...
{\footnotesize \textbf{Example 527~:} \texttt{image.jpg -to\_rgba -polaroid 5,30 -rotate 20 -drop\_shadow , -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 528~:} \texttt{image.jpg --poster\_edges ,}}
\end{center}
...
{\footnotesize \textbf{Example 529~:} \texttt{image.jpg --rodilius 12,10,300,10 -normalize\_local[-1] 10,6}}
\end{center}
...
{\footnotesize \textbf{Example 530~:} \texttt{image.jpg --stained\_glass ,}}
\end{center}
...
{\footnotesize \textbf{Example 531~:} \texttt{image.jpg -stars ,}}
\end{center}
...
{\footnotesize \textbf{Example 532~:} \texttt{image.jpg --sketchbw 1 --local -reverse -blur[-1] 3 -blend overlay -endl}}
\end{center}
...
{\footnotesize \textbf{Example 533~:} \texttt{image.jpg --sponge ,}}
\end{center}
...
{\footnotesize \textbf{Example 534~:} \texttt{image.jpg --stencil 1,10,3}}
\end{center}
...
{\footnotesize \textbf{Example 535~:} \texttt{image.jpg --stencilbw 40,4}}
\end{center}
...
{\footnotesize \textbf{Example 536~:} \texttt{image.jpg --tetris 10}}
\end{center}
...
{\footnotesize \textbf{Example 537~:} \texttt{image.jpg --warhol 5,3,3,40}}
\end{center}
...
{\footnotesize \textbf{Example 538~:} \texttt{image.jpg --weave ,}}
\end{center}
...
{\footnotesize \textbf{Example 539~:} \texttt{image.jpg --whirls ,}}
\end{center}
\section{Warpings}
...
{\footnotesize \textbf{Example 540~:} \texttt{image.jpg --euclidean2polar ,}}
\end{center}
...
{\footnotesize \textbf{Example 541~:} \texttt{image.jpg --deform[0] 10 --deform[0] 20}}
\end{center}
...
{\footnotesize \textbf{Example 542~:} \texttt{image.jpg --fisheye ,}}
\end{center}
...
{\footnotesize \textbf{Example 543~:} \texttt{image.jpg -flower ,}}
\end{center}
...
{\footnotesize \textbf{Example 544~:} \texttt{image.jpg --kaleidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 545~:} \texttt{image.jpg --map\_sphere ,}}
\end{center}
...
{\footnotesize \textbf{Example 546~:} \texttt{image.jpg --euclidean2polar , -mirror[-1] x -polar2euclidean[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 547~:} \texttt{image.jpg --raindrops ,}}
\end{center}
...
{\footnotesize \textbf{Example 548~:} \texttt{image.jpg --ripple ,}}
\end{center}
...
{\footnotesize \textbf{Example 549~:} \texttt{image.jpg --rotoidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 550~:} \texttt{image.jpg --symmetrize 50\%,50\%,45 --symmetrize[-1] 50\%,50\%,-45}}
\end{center}
...
{\footnotesize \textbf{Example 551~:} \texttt{image.jpg --transform\_polar[0] R*(r/R)\textasciicircum 2,a --transform\_polar[0] r,2*a}}
\end{center}
...
{\footnotesize \textbf{Example 552~:} \texttt{image.jpg --twirl 0.6}}
\end{center}
...
{\footnotesize \textbf{Example 553~:} \texttt{image.jpg --warp\_perspective ,}}
\end{center}
...
{\footnotesize \textbf{Example 554~:} \texttt{image.jpg --water ,}}
\end{center}
...
{\footnotesize \textbf{Example 555~:} \texttt{image.jpg --wave ,}}
\end{center}
...
{\footnotesize \textbf{Example 556~:} \texttt{image.jpg --wind ,}}
\end{center}
...
{\footnotesize \textbf{Example 557~:} \texttt{image.jpg --zoom[0] 0.6 --zoom[0] 1.5}}
\end{center}
...
{\footnotesize \textbf{Example 558~:} \texttt{image.jpg --cracks 0.2,60,1}}
\end{center}
...
{\footnotesize \textbf{Example 559~:} \texttt{image.jpg --light\_patch 20,0.9,4}}
\end{center}
...
{\footnotesize \textbf{Example 560~:} \texttt{image.jpg --noise\_hurl ,}}
\end{center}
...
{\footnotesize \textbf{Example 561~:} \texttt{image.jpg --pixelize ,}}
\end{center}
...
{\footnotesize \textbf{Example 562~:} \texttt{image.jpg --shade\_stripes 30}}
\end{center}
...
{\footnotesize \textbf{Example 563~:} \texttt{image.jpg --shadow\_patch 0.4}}
\end{center}
...
{\footnotesize \textbf{Example 564~:} \texttt{image.jpg --spread 3}}
\end{center}
...
{\footnotesize \textbf{Example 565~:} \texttt{image.jpg --stripes\_y ,}}
\end{center}
...
{\footnotesize \textbf{Example 566~:} \texttt{image.jpg --texturize\_canvas ,}}
\end{center}
...
{\footnotesize \textbf{Example 567~:} \texttt{image.jpg --texturize\_paper}}
\end{center}
...
{\footnotesize \textbf{Example 568~:} \texttt{image.jpg --vignette ,}}
\end{center}
...
{\footnotesize \textbf{Example 569~:} \texttt{image.jpg --watermark\_visible ,0.7}}
\end{center}
...
{\footnotesize \textbf{Example 570~:} \texttt{image.jpg --drop\_shadow , -resize2dy[-1] 200 -rotate[-1] 20 --blend alpha -drgba[-2]}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def571.jpg}\\
{\footnotesize \textbf{Example 571~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -blend overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def572.jpg}\\
{\footnotesize \textbf{Example 572~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex add,alpha,and,average,blue,burn,darken}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def573.jpg}\\
{\footnotesize \textbf{Example 573~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex difference,divide,dodge,exclusion,freeze,grainextract,grainmerge}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def574.jpg}\\
{\footnotesize \textbf{Example 574~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex green,hardlight,hardmix,hue,interpolation,lighten,lightness}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def575.jpg}\\
{\footnotesize \textbf{Example 575~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex linearburn,linearlight,luminance,multiply,negation,or,overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def576.jpg}\\
{\footnotesize \textbf{Example 576~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex pinlight,red,reflect,saturation,screen,shapeaverage,softburn}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def577.jpg}\\
{\footnotesize \textbf{Example 577~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex softdodge,softlight,stamp,subtract,value,vividlight,xor}}
\end{center}
...
{\footnotesize \textbf{Example 578~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --blend\_edges 0.8}}
\end{center}
...
{\footnotesize \textbf{Example 579~:} \texttt{image.jpg -testimage2d \{w\},\{h\} 100\%,100\%,1,1,'cos(y/10)' -normalize[-1] 0,1 --blend\_fade}}
\end{center}
...
{\footnotesize \textbf{Example 580~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --mirror[0] y --blend\_median}}
\end{center}
...
{\footnotesize \textbf{Example 581~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_diamond 80,85}}
\end{center}
...
{\footnotesize \textbf{Example 582~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_linear 45,48,52}}
\end{center}
...
{\footnotesize \textbf{Example 583~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_radial 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 584~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_x 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 585~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_y 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 586~:} \texttt{image.jpg -animate flower,"0,3","20,8",9}}
\end{center}
...
{\footnotesize \textbf{Example 587~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% -morph 9}}
\end{center}
...
{\footnotesize \textbf{Example 588~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% --register\_nonrigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 589~:} \texttt{image.jpg --shift 30,20 --register\_rigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 590~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -transition\_plasma 9}}
\end{center}
...
{\footnotesize \textbf{Example 591~:} \texttt{image.jpg --blur 5 -transition3d 9 -drgba}}
\end{center}
...
\subsection{\emph{-x\_metaballs\index{-x\_metaballs}} }\vspace*{-0.5em}
...
{\footnotesize \textbf{Example 592~:} \texttt{image.jpg --pink asfr,5 -pink[0] asf,5}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def593.jpg}\\
{\footnotesize \textbf{Example 593~:} \texttt{image.jpg --blur 2 -pink maxima,4}}
\end{center}
...
{\footnotesize \textbf{Example 594~:} \texttt{image.jpg --pink\_grayskel , --pink\_grayskel[0] ,10 --pink\_grayskel[0] ,100 -append\_tiles 2}}
\end{center}
...
{\footnotesize \textbf{Example 596~:} \texttt{image.jpg --blur 2 --pink\_heightminima ,15 --pink\_heightmaxima[0,1] ,15 --[-3,-1] --[-3,-1] -k[-1,-2]}}
\end{center}
...
{\footnotesize \textbf{Example 597~:} \texttt{image.jpg --pink\_htkern ,u --pink\_htkern[0] , ---[-1,-2] -rm[0]}}
\end{center}
...
{\footnotesize \textbf{Example 598~:} \texttt{image.jpg -pink\_lvkern ,u}}
\end{center}
...
{\footnotesize \textbf{Example 599~:} \texttt{image.jpg --blur 2 -pink\_reg\_minima ,}}
\end{center}
...
{\footnotesize \textbf{Example 600~:} \texttt{image.jpg -threshold 50\% \{w\},\{h\} -fill[-1] 'if(x$>$w/2,255,0)' tp=@\{-path\_tmp\} -output[-1] \$\{tp\}/inhibit.pgm -remove[-1] --pink\_skelcurv[0] , --pink\_skelcurv[0] ,,\$\{tp\}/inhibit.pgm -exec "rm "\$\{tp\}"/inhibit.pgm"}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def601.jpg}\\
{\footnotesize \textbf{Example 601~:} \texttt{image.jpg -threshold 50\% --pink\_skelcurv , --pink\_skelcurv[-2] ,8}}
\end{center}
...
{\footnotesize \textbf{Example 602~:} \texttt{image.jpg -threshold 50\% --pink\_skelend , --pink\_skelend[-2] ,-1}}
\end{center}
...
{\footnotesize \textbf{Example 603~:} \texttt{image.jpg -threshold 50\% --pink\_skeleton[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 604~:} \texttt{image.jpg -threshold 50\% --pink\_skelpar[-1] 0 --pink\_skelpar[-1] 2}}
\end{center}
...
{\footnotesize \textbf{Example 605~:} \texttt{image.jpg --pink\_wshed ,1,5 -pink\_wshed[0] ,,5}}
\end{center}
...
{\footnotesize \textbf{Example 606~:} \texttt{image.jpg --luminance -quantize[-1] 2 -label[-1] 0,1 mean=@\{"-region\_feature[0,1] 10,\textbackslash "\{ia\}\textbackslash ""\} sum=@\{"-region\_feature[0,1] 10,\textbackslash "@\{-1,+\}\textbackslash ""\}}}
\end{center}
...
{\footnotesize \textbf{Example 607~:} \texttt{-gpt ,}}
\end{center}
