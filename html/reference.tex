...
\sloppy{} 
\title{\fbox{\parbox{\textwidth}{\begin{center}\vspace*{2cm}\includegraphics[width=12cm]{logo3.jpg}\\\vspace*{1cm}{\Huge \textbf{The Handbook}\\{\small Version 1.5.7.2 (beta)}\\\vspace*{1cm}}\end{center}}}} 
...
\section*{Version} 
 ...
 gmic: GREYC's Magic for Image Computing. 
        ...
        Version 1.5.7.2 (beta), Copyright (C) 2008-2013, David Tschumperl\'e 
...
{\footnotesize \textbf{Example 311~:} \texttt{image.jpg -m "foo : -gradient x" --solve\_poisson foo --foo[0] --laplacian[1]}}
\end{center}
...
{\footnotesize \textbf{Example 312~:} \texttt{image.jpg -structuretensors -abs -pow 0.2}}
\end{center}
...
{\footnotesize \textbf{Example 313~:} \texttt{image.jpg --tv\_flow 40}}
\end{center}
...
{\footnotesize \textbf{Example 314~:} \texttt{image.jpg -blur 3 --unsharp 1.5,15 -cut 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 315~:} \texttt{image.jpg -blur 3 --unsharp\_octave 4,5,15 -cut 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 316~:} \texttt{image.jpg --vanvliet 3,1,x}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def317.jpg}\\
{\footnotesize \textbf{Example 317~:} \texttt{image.jpg --vanvliet 30,0,x -vanvliet[-2] 30,0,y -add}}
\end{center}
...
{\footnotesize \textbf{Example 318~:} \texttt{image.jpg --watermark\_fourier "Watermarked!" --display\_fft -remove[-3,-1] -normalize 0,255 -append[-4,-2] y -append[-2,-1] y}}
\end{center}
...
{\footnotesize \textbf{Example 319~:} \texttt{400,400 -noise 0.2,2 --distance 1 -mul[-1] -1 -label[-2] 0 -watershed[-2] [-1] -mod[-2] 256 -map[-2] 0 -reverse}}
\end{center}
...
{\footnotesize \textbf{Example 320~:} \texttt{image.jpg -luminance -stencil[-1] 1 --area 0}}
\end{center}
...
{\footnotesize \textbf{Example 321~:} \texttt{image.jpg -luminance -stencil[-1] 1 --area\_fg 0}}
\end{center}
...
{\footnotesize \textbf{Example 322~:} \texttt{256,256 -ellipse 50\%,50\%,20\%,20\%,0,1,1 -deform 20 --barycenter --ellipse[-2] @\{-1,0,1\},5,5,0,10}}
\end{center}
...
{\footnotesize \textbf{Example 323~:} \texttt{image.jpg --rotate 3,1,0,50\%,50\%,0.9 --displacement[-1] [-2] -quiver[-1] [-1],15,-20,1,1,\{1.5*iM\}}}
\end{center}
...
{\footnotesize \textbf{Example 324~:} \texttt{image.jpg -threshold 20\% -distance 0 -pow 0.3}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def325.jpg}\\
{\footnotesize \textbf{Example 325~:} \texttt{400,400 -set 1,50\%,50\% --distance[0] 1,2 --distance[0] 1,1 -distance[0] 1,0 -mod 32 -threshold 16 -append c}}
\end{center}
...
{\footnotesize \textbf{Example 326~:} \texttt{image.jpg -fftpolar -ellipse 50\%,50\%,10,10,0,1,0 -ifftpolar}}
\end{center}
...
{\footnotesize \textbf{Example 327~:} \texttt{image.jpg --histogram 64 -display\_graph[-1] 400,300,3}}
\end{center}
...
{\footnotesize \textbf{Example 328~:} \texttt{image.jpg --histogram\_cumul 256 -histogram[0] 256 -display\_graph 400,300,3}}
\end{center}
...
{\footnotesize \textbf{Example 329~:} \texttt{image.jpg --blur[-1] 1.5 -hough[-1] 400,400 -blur[-1] 0.5 -+[-1] 1 -log[-1]}}
\end{center}
...
{\footnotesize \textbf{Example 330~:} \texttt{image.jpg -blur 2 -isophotes 6 -dilate\_circ 5 -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 331~:} \texttt{image.jpg -luminance -threshold 60\% -label 0 -normalize 0,255 -map 0}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def332.jpg}\\
{\footnotesize \textbf{Example 332~:} \texttt{400,400 -set 1,50\%,50\% -distance 1 -mod 16 -threshold 8 -label 0 -mod 255 -map 2}}
\end{center}
...
{\footnotesize \textbf{Example 333~:} \texttt{image.jpg -norm --max\_patch 16}}
\end{center}
...
{\footnotesize \textbf{Example 334~:} \texttt{image.jpg -norm --min\_patch 16}}
\end{center}
...
{\footnotesize \textbf{Example 335~:} \texttt{image.jpg --gradient\_norm -f[-1] 1/(1+i) -minimal\_path[-1] 0,0,0,100\%,100\%,0 -pointcloud[-1] 0 -*[-1] 280 -to\_rgb[-1] -resize[-1] [-2],0 -or}}
\end{center}
...
{\footnotesize \textbf{Example 336~:} \texttt{image.jpg --noise 30 --noise[0] 35 --noise[0] 38 -cut[-1] 0,255 -mse}}
\end{center}
...
{\footnotesize \textbf{Example 337~:} \texttt{image.jpg --patches 64,64,1,153,124,0,184,240,0,217,126,0,275,38,0}}
\end{center}
...
{\footnotesize \textbf{Example 338~:} \texttt{400,300,1,1,'if(y$>$300*abs(cos(x/10+2*?)),1,0)' --plot2value --display\_graph[-1] 400,300}}
\end{center}
...
{\footnotesize \textbf{Example 339~:} \texttt{3000,2 -rand 0,400 --pointcloud 0 -dilate[-1] 3}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def340.jpg}\\
{\footnotesize \textbf{Example 340~:} \texttt{3000,2 -rand 0,400 \{w\} \{w\},3 -rand[-1] 0,255 -append y --pointcloud 0 -dilate[-1] 3}}
\end{center}
...
{\footnotesize \textbf{Example 341~:} \texttt{image.jpg --noise 30 --noise[0] 35 --noise[0] 38 -cut[-1] 0,255 -psnr 255 -replace\_inf 0}}
\end{center}
...
{\footnotesize \textbf{Example 342~:} \texttt{image.jpg --segment\_watershed 2,0}}
\end{center}
...
{\footnotesize \textbf{Example 343~:} \texttt{image.jpg -threshold 50\% --skeleton 0}}
\end{center}
...
{\footnotesize \textbf{Example 344~:} \texttt{image.jpg --crop 20\%,20\%,35\%,35\% --ssd\_patch 0,0}}
\end{center}
...
{\footnotesize \textbf{Example 345~:} \texttt{image.jpg -threshold 50\% --thinning}}
\end{center}
...
{\footnotesize \textbf{Example 346~:} \texttt{image.jpg --tones 3}}
\end{center}
...
{\footnotesize \textbf{Example 347~:} \texttt{image.jpg --topographic\_map 10}}
\end{center}
...
{\footnotesize \textbf{Example 348~:} \texttt{400,400,1,3,255 -axes -1,1,1,-1}}
\end{center}
...
{\footnotesize \textbf{Example 349~:} \texttt{32,32 64,64 200,200 256,256 -ball 255,164,100}}
\end{center}
...
{\footnotesize \textbf{Example 350~:} \texttt{image.jpg -chessboard 32,32,0,0,25,0.3,255,128,0,0,128,255}}
\end{center}
...
{\footnotesize \textbf{Example 351~:} \texttt{500,400,1,3 -cie1931}}
\end{center}
...
{\footnotesize \textbf{Example 352~:} \texttt{image.jpg -repeat 300 -circle \{?(100)\}\%,\{?(100)\}\%,\{?(30)\},0.3,@\{-RGB\} -done -circle 50\%,50\%,100,0.7,255}}
\end{center}
...
{\footnotesize \textbf{Example 353~:} \texttt{image.jpg -repeat 300 -ellipse \{?(100)\}\%,\{?(100)\}\%,\{?(30)\},\{?(30)\},\{?(180)\},0.3,@\{-RGB\} -done -ellipse 50\%,50\%,100,100,0,0.7,255}}
\end{center}
...
{\footnotesize \textbf{Example 354~:} \texttt{image.jpg -repeat 1000 -flood \{?(100)\}\%,\{?(100)\}\%,0,20,0,1,@\{-RGB\} -done}}
\end{center}
...
{\footnotesize \textbf{Example 355~:} \texttt{400,400 -gaussian 100,30,45}}
\end{center}
...
{\footnotesize \textbf{Example 356~:} \texttt{image.jpg --rows 50\% -blur[-1] 3 -s[-1] c -div[0] 1.5 -graph[0] [1],2,0,0,0,1,255,0,0 -graph[0] [2],2,0,0,0,1,0,255,0 -graph[0] [3],2,0,0,0,1,0,0,255 -keep[0]}}
\end{center}
...
{\footnotesize \textbf{Example 357~:} \texttt{image.jpg -grid 10\%,10\%,0,0,0.5,255}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def358.jpg}\\
{\footnotesize \textbf{Example 358~:} \texttt{400,400,1,3,255 -grid 10\%,10\%,0,0,0.3,0xCCCCCCCC,128,32,16}}
\end{center}
...
{\footnotesize \textbf{Example 359~:} \texttt{image.jpg --crop 40\%,40\%,60\%,60\% -resize[-1] 200\%,200\%,1,3,5 -frame[-1] 2,2,0 -image[0] [-1],30\%,30\% -keep[0]}}
\end{center}
...
{\footnotesize \textbf{Example 360~:} \texttt{image.jpg -repeat 500 -line 50\%,50\%,\{?(w)\},\{?(h)\},0.5,@\{-RGB\} -done -line 0,0,100\%,100\%,1,0xCCCCCCCC,255 -line 100\%,0,0,100\%,1,0xCCCCCCCC,255}}
\end{center}
...
{\footnotesize \textbf{Example 361~:} \texttt{400,400 -mandelbrot -2.5,-2,2,2,1024 -map 0 --blur 2 -elevation3d[-1] -0.2}}
\end{center}
...
{\footnotesize \textbf{Example 362~:} \texttt{image.jpg --marble ,}}
\end{center}
...
{\footnotesize \textbf{Example 363~:} \texttt{-maze 30,20 -negative -n 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 364~:} \texttt{0 -text "G'MIC",0,0,57,1,1 -dilate 3 -autocrop 0 -frame 1,1,0 -maze\_mask 8 -dilate 3 -negative -* 255}}
\end{center}
...
{\footnotesize \textbf{Example 365~:} \texttt{image.jpg -torus3d 100,10 -cone3d 30,-120 -add3d[-2,-1] -rotate3d[-1] 1,1,0,60 -object3d[0] [-1],50\%,50\% -keep[0]}}
\end{center}
...
{\footnotesize \textbf{Example 366~:} \texttt{512,512,1,3,"min(255,y*c/2)" 100\%,100\% -circle 50\%,50\%,100,1,255 -append c image.jpg -resize2dy[-1] 24 -to\_rgba -pack\_sprites 3,25}}
\end{center}
...
{\footnotesize \textbf{Example 367~:} \texttt{image.jpg -piechart 25,0,0,0,"Red",55,255,0,0,"Green",40,0,255,0,"Blue",30,128,128,255,"Other",5,128,128,128}}
\end{center}
...
{\footnotesize \textbf{Example 368~:} \texttt{400,400,1,3 -plasma 1}}
\end{center}
...
{\footnotesize \textbf{Example 369~:} \texttt{image.jpg -repeat 10000 -point \{?(100)\}\%,\{?(100)\}\%,0,1,@\{-RGB\} -done}}
\end{center}
...
{\footnotesize \textbf{Example 370~:} \texttt{image.jpg -polka\_dots 10,15,0,0,20,10,1,0.5,0,128,255}}
\end{center}
...
{\footnotesize \textbf{Example 371~:} \texttt{image.jpg -polygon 4,20\%,20\%,80\%,30\%,80\%,70\%,20\%,80\%,0.3,0,255,0 -polygon 4,20\%,20\%,80\%,30\%,80\%,70\%,20\%,80\%,1,0xCCCCCCCC,255}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def372.jpg}\\
{\footnotesize \textbf{Example 372~:} \texttt{image.jpg 2,16,1,1,'?(if(x,@\{-1,h\},@\{-1,w\}))' -polygon[-2] \{h\},@-1,0.6,255,0,255 -remove[-1]}}
\end{center}
...
{\footnotesize \textbf{Example 373~:} \texttt{100,100,1,2,'if(c==0,x-w/2,y-h/2)' 500,500,1,3,255 -quiver[-1] [-2],10}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def374.jpg}\\
{\footnotesize \textbf{Example 374~:} \texttt{image.jpg --resize2dy 600 -luminance[0] -gradient[0] -mul[1] -1 -reverse[0,1] -append[0,1] c -blur[0] 8 -orientation[0] -quiver[1] [0],10,10,1,0.8,255}}
\end{center}
...
{\footnotesize \textbf{Example 375~:} \texttt{image.jpg -repeat 30 -rectangle \{?(100)\}\%,\{?(100)\}\%,\{?(100)\}\%,\{?(100)\}\%,0.3,@\{-RGB\} -done}}
\end{center}
...
{\footnotesize \textbf{Example 376~:} \texttt{400,400 -rorschach 3\%}}
\end{center}
...
{\footnotesize \textbf{Example 377~:} \texttt{image.jpg -sierpinski 7}}
\end{center}
...
{\footnotesize \textbf{Example 378~:} \texttt{image.jpg -snowflake 4}}
\end{center}
...
{\footnotesize \textbf{Example 379~:} \texttt{16,16 -spiralbw}}
\end{center}
...
{\footnotesize \textbf{Example 380~:} \texttt{image.jpg -repeat 30 -spline \{?(100)\}\%,\{?(100)\}\%,\{?(-600,600)\},\{?(-600,600)\},\{?(100)\}\%,\{?(100)\}\%,\{?(-600,600)\},\{?(-600,600)\},256,0.3,255 -done}}
\end{center}
...
{\footnotesize \textbf{Example 381~:} \texttt{image.jpg -resize2dy 600 y=0 -repeat 30 -text \{2*\$$>$\}" : This is a nice text, isn't it ?",10,\$y,\{2*\$$>$\},0.9,255 y=\{\$y+2*\$$>$\} -done}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def382.jpg}\\
{\footnotesize \textbf{Example 382~:} \texttt{0 -text "G'MIC",0,0,24,1,255}}
\end{center}
...
{\footnotesize \textbf{Example 383~:} \texttt{image.jpg -text\_outline "Hi there!",10,10,52,3}}
\end{center}
...
{\footnotesize \textbf{Example 384~:} \texttt{image.jpg -triangle\_shade 20,20,400,100,120,200,255,0,0,0,255,0,0,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 385~:} \texttt{400,300 -truchet ,}}
\end{center}
...
{\footnotesize \textbf{Example 386~:} \texttt{400,400,1,3 -turbulence 16}}
\end{center}
...
{\footnotesize \textbf{Example 387~:} \texttt{400,400 -yinyang}}
\end{center}
...
{\footnotesize \textbf{Example 388~:} \texttt{(1,0,0;0,2,0;0,0,3) --eigen}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def389.jpg}\\
{\footnotesize \textbf{Example 389~:} \texttt{image.jpg -structuretensors -blur 2 -eigen -split[0] c}}
\end{center}
...
{\footnotesize \textbf{Example 390~:} \texttt{(0,1,0;0,0,1;1,0,0) --invert}}
\end{center}
...
{\footnotesize \textbf{Example 391~:} \texttt{(0,1,0;1,0,0;0,0,1) (1;2;3) --solve[-1] [-2]}}
\end{center}
...
{\footnotesize \textbf{Example 392~:} \texttt{10,10,1,1,'if(x==y,x+?(-0.2,0.2),0)' --svd}}
\end{center}
...
{\footnotesize \textbf{Example 393~:} \texttt{image.jpg --transpose}}
\end{center}
...
{\footnotesize \textbf{Example 394~:} \texttt{(0,0,1;1,0,0;0,1,0) (1;2;3) --trisolve[-1] [-2]}}
\end{center}
...
{\footnotesize \textbf{Example 395~:} \texttt{-sphere3d 10 -repeat 5 --add3d[-1] 10,\{?(-10,10)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def396.jpg}\\
{\footnotesize \textbf{Example 396~:} \texttt{-repeat 20 -torus3d 15,2 -color3d[-1] @\{-RGB\} -mul3d[-1] 0.5,1 -if \{\$$>$\%2\} -rotate3d[-1] 0,1,0,90 -endif -add3d[-1] 70 -add3d -rotate3d[-1] 0,0,1,18 -done -double3d 0}}
\end{center}
...
{\footnotesize \textbf{Example 397~:} \texttt{-torus3d 100,20 -apply\_pose3d 0.152437,1.20666,-0.546366,0,-0.535962,0.559129,1.08531,0,1.21132,0.0955431,0.548966,0,0,0,-206,1 -snapshot3d 400}}
\end{center}
...
{\footnotesize \textbf{Example 398~:} \texttt{-axes3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 399~:} \texttt{-box3d 100,40,30 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 400~:} \texttt{-repeat 100 -circle3d \{?(100)\},\{?(100)\},\{?(100)\},2 -done -add3d -color3d[-1] 255,0,0 --center3d -color3d[-1] 0,255,0 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 401~:} \texttt{-repeat 500 a=\{\$$>$*pi/250\} -circle3d \{cos(3*\$a)\},\{sin(2*\$a)\},0,\{\$a/50\} -color3d[-1] @\{-RGB\},0.4 -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 402~:} \texttt{image.jpg -luminance -resize2dy 40 -threshold 50\% -* 255 -pointcloud3d -color3d[-1] 255,255,255 -circles3d 0.7}}
\end{center}
...
{\footnotesize \textbf{Example 403~:} \texttt{-torus3d 100,10 -double3d 0 -repeat 7 --rotate3d[-1] 1,0,0,20 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 404~:} \texttt{-colorcube3d -mode3d 2 --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 405~:} \texttt{-cone3d 10,40 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 406~:} \texttt{-cup3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 407~:} \texttt{-cylinder3d 10,40 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 408~:} \texttt{image.jpg -distribution3d -colorcube3d -primitives3d[-1] 1 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 409~:} \texttt{-torus3d 5,2 -repeat 5 --add3d[-1] 12,0,0 -div3d[-1] 1.2 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 410~:} \texttt{-mode3d 1 -repeat 2 -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -double3d \$$>$ -snapshot3d[-1] 400 -done}}
\end{center}
...
{\footnotesize \textbf{Example 411~:} \texttt{image.jpg -blur 5 -elevation3d 0.5}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def412.jpg}\\
{\footnotesize \textbf{Example 412~:} \texttt{128,128,1,3,?(255) -plasma 10,3 -blur 4 -sharpen 10000 -elevation3d[-1] 'X=(x-64)/6;Y=(y-64)/6;100*exp(-(X\textasciicircum 2+Y\textasciicircum 2)/30)*abs(cos(X)*sin(Y))'}}
\end{center}
...
{\footnotesize \textbf{Example 413~:} \texttt{-empty3d}}
\end{center}
...
{\footnotesize \textbf{Example 414~:} \texttt{image.jpg -threshold 50\% -extrude3d 16}}
\end{center}
...
{\footnotesize \textbf{Example 415~:} \texttt{-repeat 5 -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -focale3d \{\$$<$*90\} -snapshot3d[-1] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 416~:} \texttt{image.jpg -r2dy 32 -distribution3d -gaussians3d 20 -colorcube3d -primitives3d[-1] 1 -+3d}}
\end{center}
...
{\footnotesize \textbf{Example 417~:} \texttt{-gmic3d --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 418~:} \texttt{-gyroid3d 48 --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 419~:} \texttt{image.jpg -histogram3d -colorcube3d -primitives3d[-1] 1 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 420~:} \texttt{image.jpg -animate flower,"30,0","30,5",6 -image6cube3d}}
\end{center}
...
{\footnotesize \textbf{Example 421~:} \texttt{image.jpg -imagecube3d}}
\end{center}
...
{\footnotesize \textbf{Example 422~:} \texttt{image.jpg -imageplane3d}}
\end{center}
...
{\footnotesize \textbf{Example 423~:} \texttt{image.jpg -imagepyramid3d}}
\end{center}
...
{\footnotesize \textbf{Example 424~:} \texttt{image.jpg -imagerubik3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 425~:} \texttt{image.jpg -imagesphere3d 32,16}}
\end{center}
...
{\footnotesize \textbf{Example 426~:} \texttt{image.jpg -blur 1 -isoline3d 50\%}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def427.jpg}\\
{\footnotesize \textbf{Example 427~:} \texttt{-isoline3d 'X=x-w/2;Y=y-h/2;(X\textasciicircum 2+Y\textasciicircum 2)\%20',10,-10,-10,10,10}}
\end{center}
...
{\footnotesize \textbf{Example 428~:} \texttt{image.jpg -resize2dy 128 -luminance -threshold 50\% -expand\_z 2,0 -blur 1 -isosurface3d 50\% -mul3d 1,1,30}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def429.jpg}\\
{\footnotesize \textbf{Example 429~:} \texttt{-isosurface3d 'x\textasciicircum 2+y\textasciicircum 2+abs(z)\textasciicircum abs(4*cos(x*y*z*3))',3}}
\end{center}
...
{\footnotesize \textbf{Example 430~:} \texttt{-torus3d 100,40,6,6 -label\_points3d 24,1 -mode3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 431~:} \texttt{300,300 -rand -1,1 -blur 40 -sign -normalize 0,255 -lathe3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 432~:} \texttt{-torus3d 100,30 -double3d 0 -specs3d 1.2 -repeat 5 -light3d \{\$$>$*100\},0,-300 --snapshot3d[0] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 433~:} \texttt{-repeat 100 a=\{\$$>$*pi/50\} -line3d 0,0,0,\{cos(3*\$a)\},\{sin(2*\$a)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 434~:} \texttt{-lissajous3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 435~:} \texttt{(0,1,2,3,4,5) -double3d 0 -repeat \{w\} -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -mode3d @\{0,\$$>$\} -snapshot3d[-1] 300 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 436~:} \texttt{-torus3d 5,2 -repeat 5 --add3d[-1] 10,0,0 -mul3d[-1] 1.2 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 437~:} \texttt{-repeat 100 -circle3d \{?(3)\},\{?(3)\},\{?(3)\},0.1 -done -add3d -color3d[-1] 255,0,0 --normalize3d[-1] -color3d[-1] 0,255,0 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 438~:} \texttt{-torus3d 100,10 -double3d 0 -repeat 7 --rotate3d[-1] 1,0,0,20 -opacity3d[-1] \{?\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 439~:} \texttt{-parametric3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 440~:} \texttt{image.jpg -pca\_patch3d 7}}
\end{center}
...
{\footnotesize \textbf{Example 441~:} \texttt{-plane3d 50,30 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 442~:} \texttt{-repeat 1000 a=\{\$$>$*pi/500\} -point3d \{cos(3*\$a)\},\{sin(2*\$a)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 443~:} \texttt{image.jpg -luminance -resize2dy 100 -threshold 50\% -* 255 -pointcloud3d -color3d[-1] 255,255,255}}
\end{center}
...
{\footnotesize \textbf{Example 444~:} \texttt{-sphere3d 30 -primitives3d 1 -torus3d 50,10 -color3d[-1] @\{-RGB\} -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 445~:} \texttt{-pyramid3d 100,100 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 446~:} \texttt{-quadrangle3d -10,-10,10,10,-10,10,10,10,10,-10,10,10 -repeat 10 --rotate3d[-1] 0,1,0,30 -color3d[-1] @\{-RGB\},0.6 -done -add3d -mode3d 2}}
\end{center}
...
{\footnotesize \textbf{Example 447~:} \texttt{-torus3d 100,40 -double3d 0 --reverse3d}}
\end{center}
...
{\footnotesize \textbf{Example 448~:} \texttt{-torus3d 100,10 -double3d 0 -repeat 7 --rotate3d[-1] 1,0,0,20 -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 449~:} \texttt{-rotation3d 1,0,0,0 -rotation3d 1,0,0,90 -rotation3d 1,0,0,180}}
\end{center}
...
{\footnotesize \textbf{Example 450~:} \texttt{-sierpinski3d 3 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 451~:} \texttt{-torus3d 100,20 -snapshot3d 400,1.2,128,64,32}}
\end{center}
...
{\footnotesize \textbf{Example 452~:} \texttt{(0,0.3,0.6,0.9,1.2) -repeat \{w\} -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -color3d[-1] 255,0,0 -specl3d @\{0,\$$>$\} -snapshot3d[-1] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 453~:} \texttt{(0,0.3,0.6,0.9,1.2) -repeat \{w\} -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -color3d[-1] 255,0,0 -specs3d @\{0,\$$>$\} -snapshot3d[-1] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 454~:} \texttt{-sphere3d 100 --primitives3d 1  -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 455~:} \texttt{-spherical3d 64 --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 456~:} \texttt{-repeat 100 -spline3d \{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},128 -color3d[-1] @\{-RGB\} -done -box3d 1 -primitives3d[-1] 1 -+3d}}
\end{center}
...
{\footnotesize \textbf{Example 457~:} \texttt{-box3d 100 --split3d}}
\end{center}
...
{\footnotesize \textbf{Example 458~:} \texttt{image.jpg -sprite3d}}
\end{center}
...
{\footnotesize \textbf{Example 459~:} \texttt{-torus3d 100,20 image.jpg -resize2dy[-1] 64 100\%,100\% -gaussian[-1] 30\%,30\% -*[-1] 255 -append[-2,-1] c --sprites3d -drgba[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 460~:} \texttt{-star3d , --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 461~:} \texttt{100,100,100,3 -rand -10,10 -blur 3 -repeat 300 --streamline3d[0] \{?(100)\},\{?(100)\},\{?(100)\},1000,1,1 -color3d[-1] @\{-RGB\} -done -rm[0] -box3d 100 -primitives3d[-1] 1 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 462~:} \texttt{-sphere3d 10 -repeat 5 --sub3d[-1] 10,\{?(-10,10)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 463~:} \texttt{-superformula3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 464~:} \texttt{-text\_pointcloud3d "G'MIC","Rocks!"}}
\end{center}
...
{\footnotesize \textbf{Example 465~:} \texttt{-text3d "G'MIC as a\textbackslash n3D logo!"}}
\end{center}
...
{\footnotesize \textbf{Example 466~:} \texttt{image.jpg -torus3d 100,30 -texturize3d[-1] [-2] -keep[-1]}}
\end{center}
...
{\footnotesize \textbf{Example 467~:} \texttt{-torus3d 10,3 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 468~:} \texttt{-repeat 100 a=\{\$$>$*pi/50\} -triangle3d 0,0,0,0,0,3,\{cos(3*\$a)\},\{sin(2*\$a)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 469~:} \texttt{image.jpg -animate blur,0,5,30 -a z -volume3d}}
\end{center}
...
{\footnotesize \textbf{Example 470~:} \texttt{-weird3d 48 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 471~:} \texttt{image.jpg --mirror x --mirror y -apply\_parallel "-blur 3"}}
\end{center}
...
{\footnotesize \textbf{Example 472~:} \texttt{image.jpg --apply\_parallel\_overlap "-smooth 500,0,1",16}}
\end{center}
...
{\footnotesize \textbf{Example 473~:} \texttt{image.jpg -repeat 10 -blur 1 -if \{1==1\} -continue -endif -deform 10 -done}}
\end{center}
...
{\footnotesize \textbf{Example 474~:} \texttt{image.jpg -repeat 10 -blur 1 -if \{1==1\} -break -endif -deform 10 -done}}
\end{center}
...
{\footnotesize \textbf{Example 475~:} \texttt{image.jpg -luminance i=\{ia+2\} -do -set 255,\{?(100)\}\%,\{?(100)\}\% -while \{ia$<$\$i\}}}
\end{center}
...
{\footnotesize \textbf{Example 476~:} \texttt{image.jpg -if \{ia$<$64\} -add 50\% -elif \{ia$<$128\} -add 25\% -elif \{ia$<$192\} -sub 25\% -else -sub 50\% -endif -cut 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 477~:} \texttt{image.jpg -local[] 300,300,1,3 -rand[0] 0,255 -blur 4 -sharpen 1000 -endlocal}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def478.jpg}\\
{\footnotesize \textbf{Example 478~:} \texttt{image.jpg --local -repeat 3 -deform 20 -done -endlocal}}
\end{center}
...
{\footnotesize \textbf{Example 479~:} \texttt{image.jpg --local -blur -3 -onfail -mirror x -endlocal}}
\end{center}
...
{\footnotesize \textbf{Example 480~:} \texttt{image.jpg [0] -parallel "-blur[0] 3","-mirror[1] c"}}
\end{center}
...
{\footnotesize \textbf{Example 481~:} \texttt{image.jpg -split y -repeat @\% -shift[\$$>$] \$$<$,0,0,0,2 -done -append y}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def482.jpg}\\
{\footnotesize \textbf{Example 482~:} \texttt{image.jpg -mode3d 2 -repeat 4 -imagecube3d -rotate3d 1,1,0,40 -snapshot3d 400,1.4 -done}}
\end{center}
...
{\footnotesize \textbf{Example 483~:} \texttt{image.jpg -command "foo : u0=Dark u1=Bright -status \$\{u\{ia$>$=128\}\}" -text\_outline @\{-foo\},2,2,24,2,1,255}}
\end{center}
...
{\footnotesize \textbf{Example 484~:} \texttt{image.jpg -array 3,2,2}}
\end{center}
...
{\footnotesize \textbf{Example 485~:} \texttt{image.jpg -array\_fade 3,2}}
\end{center}
...
{\footnotesize \textbf{Example 486~:} \texttt{image.jpg -array\_mirror 2}}
\end{center}
...
{\footnotesize \textbf{Example 487~:} \texttt{image.jpg --array\_random 8,8,15,10}}
\end{center}
...
{\footnotesize \textbf{Example 488~:} \texttt{image.jpg -frame\_blur 3,30,8,10\%}}
\end{center}
...
{\footnotesize \textbf{Example 489~:} \texttt{image.jpg -frame\_cube ,}}
\end{center}
...
{\footnotesize \textbf{Example 490~:} \texttt{image.jpg -frame\_fuzzy 20}}
\end{center}
...
{\footnotesize \textbf{Example 491~:} \texttt{image.jpg -frame\_painting ,}}
\end{center}
...
{\footnotesize \textbf{Example 492~:} \texttt{image.jpg -frame\_pattern 8}}
\end{center}
...
{\footnotesize \textbf{Example 493~:} \texttt{image.jpg -frame\_round 10}}
\end{center}
...
{\footnotesize \textbf{Example 494~:} \texttt{image.jpg -frame\_x 20,255,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 495~:} \texttt{image.jpg -frame\_xy 1,1,0 -frame\_xy 20,10,255,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 496~:} \texttt{image.jpg -frame\_y 20,255,0,255}}
\end{center}
...
{\footnotesize \textbf{Example 497~:} \texttt{image.jpg -imagegrid 16}}
\end{center}
...
{\footnotesize \textbf{Example 498~:} \texttt{image.jpg --linearize\_tiles 16}}
\end{center}
...
{\footnotesize \textbf{Example 499~:} \texttt{image.jpg --quadratize\_tiles 16}}
\end{center}
...
{\footnotesize \textbf{Example 500~:} \texttt{image.jpg -to\_rgba -rotate\_tiles 10,8 -drop\_shadow 10,10 -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 501~:} \texttt{image.jpg --shift\_tiles 8,8,10}}
\end{center}
...
{\footnotesize \textbf{Example 502~:} \texttt{image.jpg --taquin 8}}
\end{center}
...
{\footnotesize \textbf{Example 503~:} \texttt{image.jpg --tunnel 20}}
\end{center}
\section{Artistic}
...
{\footnotesize \textbf{Example 504~:} \texttt{image.jpg --boxfitting ,}}
\end{center}
...
{\footnotesize \textbf{Example 505~:} \texttt{image.jpg --cartoon 3,80,15}}
\end{center}
...
{\footnotesize \textbf{Example 506~:} \texttt{image.jpg --circlism ,}}
\end{center}
...
{\footnotesize \textbf{Example 507~:} \texttt{image.jpg --color\_ellipses ,,0.15}}
\end{center}
...
{\footnotesize \textbf{Example 508~:} \texttt{image.jpg --cubism ,}}
\end{center}
...
{\footnotesize \textbf{Example 509~:} \texttt{image.jpg --dotsbw , --blend shapeaverage0}}
\end{center}
...
{\footnotesize \textbf{Example 510~:} \texttt{image.jpg --draw\_whirl ,}}
\end{center}
...
{\footnotesize \textbf{Example 511~:} \texttt{image.jpg --drawing ,}}
\end{center}
...
{\footnotesize \textbf{Example 512~:} \texttt{image.jpg -drop\_shadow 10,20,5,0.5 -expand\_xy 20,0 -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 513~:} \texttt{image.jpg --ellipsionism ,}}
\end{center}
...
{\footnotesize \textbf{Example 514~:} \texttt{image.jpg -fire\_edges ,}}
\end{center}
...
{\footnotesize \textbf{Example 515~:} \texttt{image.jpg --glow ,}}
\end{center}
...
{\footnotesize \textbf{Example 516~:} \texttt{image.jpg --halftone ,}}
\end{center}
...
{\footnotesize \textbf{Example 517~:} \texttt{image.jpg --hardsketchbw 200,70,0.1,10 -median[-1] 2 --local -reverse -blur[-1] 3 -blend overlay -endl}}
\end{center}
...
{\footnotesize \textbf{Example 518~:} \texttt{image.jpg --hearts ,}}
\end{center}
...
{\footnotesize \textbf{Example 519~:} \texttt{image.jpg --houghsketchbw ,}}
\end{center}
...
{\footnotesize \textbf{Example 520~:} \texttt{image.jpg --lightrays , -+ -c 0,255}}
\end{center}
...
{\footnotesize \textbf{Example 521~:} \texttt{image.jpg --blur 2 -light\_relief[-1] 0.3,4,0.1,0}}
\end{center}
...
{\footnotesize \textbf{Example 522~:} \texttt{image.jpg --mosaic ,}}
\end{center}
...
{\footnotesize \textbf{Example 523~:} \texttt{image.jpg --old\_photo}}
\end{center}
...
{\footnotesize \textbf{Example 524~:} \texttt{image.jpg --pencilbw ,}}
\end{center}
...
{\footnotesize \textbf{Example 525~:} \texttt{image.jpg -to\_rgba -polaroid 5,30 -rotate 20 -drop\_shadow , -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 526~:} \texttt{image.jpg --poster\_edges ,}}
\end{center}
...
{\footnotesize \textbf{Example 527~:} \texttt{image.jpg --rodilius 12,10,300,10 -normalize\_local[-1] 10,6}}
\end{center}
...
{\footnotesize \textbf{Example 528~:} \texttt{image.jpg --stained\_glass ,}}
\end{center}
...
{\footnotesize \textbf{Example 529~:} \texttt{image.jpg -stars ,}}
\end{center}
...
{\footnotesize \textbf{Example 530~:} \texttt{image.jpg --sketchbw 1 --local -reverse -blur[-1] 3 -blend overlay -endl}}
\end{center}
...
{\footnotesize \textbf{Example 531~:} \texttt{image.jpg --sponge ,}}
\end{center}
...
{\footnotesize \textbf{Example 532~:} \texttt{image.jpg --stencil 1,10,3}}
\end{center}
...
{\footnotesize \textbf{Example 533~:} \texttt{image.jpg --stencilbw 40,4}}
\end{center}
...
{\footnotesize \textbf{Example 534~:} \texttt{image.jpg --tetris 10}}
\end{center}
...
{\footnotesize \textbf{Example 535~:} \texttt{image.jpg --warhol 5,3,3,40}}
\end{center}
...
{\footnotesize \textbf{Example 536~:} \texttt{image.jpg --weave ,}}
\end{center}
...
{\footnotesize \textbf{Example 537~:} \texttt{image.jpg --whirls ,}}
\end{center}
\section{Warpings}
...
{\footnotesize \textbf{Example 538~:} \texttt{image.jpg --euclidean2polar ,}}
\end{center}
...
{\footnotesize \textbf{Example 539~:} \texttt{image.jpg --deform[0] 10 --deform[0] 20}}
\end{center}
...
{\footnotesize \textbf{Example 540~:} \texttt{image.jpg --fisheye ,}}
\end{center}
...
{\footnotesize \textbf{Example 541~:} \texttt{image.jpg -flower ,}}
\end{center}
...
{\footnotesize \textbf{Example 542~:} \texttt{image.jpg --kaleidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 543~:} \texttt{image.jpg --map\_sphere ,}}
\end{center}
...
{\footnotesize \textbf{Example 544~:} \texttt{image.jpg --euclidean2polar , -mirror[-1] x -polar2euclidean[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 545~:} \texttt{image.jpg --raindrops ,}}
\end{center}
...
{\footnotesize \textbf{Example 546~:} \texttt{image.jpg --ripple ,}}
\end{center}
...
{\footnotesize \textbf{Example 547~:} \texttt{image.jpg --rotoidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 548~:} \texttt{image.jpg --symmetrize 50\%,50\%,45 --symmetrize[-1] 50\%,50\%,-45}}
\end{center}
...
{\footnotesize \textbf{Example 549~:} \texttt{image.jpg --transform\_polar[0] R*(r/R)\textasciicircum 2,a --transform\_polar[0] r,2*a}}
\end{center}
...
{\footnotesize \textbf{Example 550~:} \texttt{image.jpg --twirl 0.6}}
\end{center}
...
{\footnotesize \textbf{Example 551~:} \texttt{image.jpg --warp\_perspective ,}}
\end{center}
...
{\footnotesize \textbf{Example 552~:} \texttt{image.jpg --water ,}}
\end{center}
...
{\footnotesize \textbf{Example 553~:} \texttt{image.jpg --wave ,}}
\end{center}
...
{\footnotesize \textbf{Example 554~:} \texttt{image.jpg --wind ,}}
\end{center}
...
{\footnotesize \textbf{Example 555~:} \texttt{image.jpg --zoom[0] 0.6 --zoom[0] 1.5}}
\end{center}
...
{\footnotesize \textbf{Example 556~:} \texttt{image.jpg --cracks 0.2,60,1}}
\end{center}
...
{\footnotesize \textbf{Example 557~:} \texttt{image.jpg --light\_patch 20,0.9,4}}
\end{center}
...
{\footnotesize \textbf{Example 558~:} \texttt{image.jpg --noise\_hurl ,}}
\end{center}
...
{\footnotesize \textbf{Example 559~:} \texttt{image.jpg --pixelize ,}}
\end{center}
...
{\footnotesize \textbf{Example 560~:} \texttt{image.jpg --shade\_stripes 30}}
\end{center}
...
{\footnotesize \textbf{Example 561~:} \texttt{image.jpg --shadow\_patch 0.4}}
\end{center}
...
{\footnotesize \textbf{Example 562~:} \texttt{image.jpg --spread 3}}
\end{center}
...
{\footnotesize \textbf{Example 563~:} \texttt{image.jpg --stripes\_y ,}}
\end{center}
...
{\footnotesize \textbf{Example 564~:} \texttt{image.jpg --texturize\_canvas ,}}
\end{center}
...
{\footnotesize \textbf{Example 565~:} \texttt{image.jpg --texturize\_paper}}
\end{center}
...
{\footnotesize \textbf{Example 566~:} \texttt{image.jpg --vignette ,}}
\end{center}
...
{\footnotesize \textbf{Example 567~:} \texttt{image.jpg --watermark\_visible ,0.7}}
\end{center}
...
{\footnotesize \textbf{Example 568~:} \texttt{image.jpg --drop\_shadow , -resize2dy[-1] 200 -rotate[-1] 20 --blend alpha -drgba[-2]}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def569.jpg}\\
{\footnotesize \textbf{Example 569~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -blend overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def570.jpg}\\
{\footnotesize \textbf{Example 570~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex add,alpha,and,average,blue,burn,darken}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def571.jpg}\\
{\footnotesize \textbf{Example 571~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex difference,divide,dodge,exclusion,freeze,grainextract,grainmerge}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def572.jpg}\\
{\footnotesize \textbf{Example 572~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex green,hardlight,hardmix,hue,interpolation,lighten,lightness}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def573.jpg}\\
{\footnotesize \textbf{Example 573~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex linearburn,linearlight,luminance,multiply,negation,or,overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def574.jpg}\\
{\footnotesize \textbf{Example 574~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex pinlight,red,reflect,saturation,screen,shapeaverage,softburn}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def575.jpg}\\
{\footnotesize \textbf{Example 575~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex softdodge,softlight,stamp,subtract,value,vividlight,xor}}
\end{center}
...
{\footnotesize \textbf{Example 576~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --blend\_edges 0.8}}
\end{center}
...
{\footnotesize \textbf{Example 577~:} \texttt{image.jpg -testimage2d \{w\},\{h\} 100\%,100\%,1,1,'cos(y/10)' -normalize[-1] 0,1 --blend\_fade}}
\end{center}
...
{\footnotesize \textbf{Example 578~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --mirror[0] y --blend\_median}}
\end{center}
...
{\footnotesize \textbf{Example 579~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_diamond 80,85}}
\end{center}
...
{\footnotesize \textbf{Example 580~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_linear 45,48,52}}
\end{center}
...
{\footnotesize \textbf{Example 581~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_radial 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 582~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_x 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 583~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_y 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 584~:} \texttt{image.jpg -animate flower,"0,3","20,8",9}}
\end{center}
...
{\footnotesize \textbf{Example 585~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% -morph 9}}
\end{center}
...
{\footnotesize \textbf{Example 586~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% --register\_nonrigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 587~:} \texttt{image.jpg --shift 30,20 --register\_rigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 588~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -transition\_plasma 9}}
\end{center}
...
{\footnotesize \textbf{Example 589~:} \texttt{image.jpg --blur 5 -transition3d 9 -drgba}}
\end{center}
...
{\footnotesize \textbf{Example 590~:} \texttt{image.jpg --pink asfr,5 -pink[0] asf,5}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def591.jpg}\\
{\footnotesize \textbf{Example 591~:} \texttt{image.jpg --blur 2 -pink maxima,4}}
\end{center}
...
{\footnotesize \textbf{Example 592~:} \texttt{image.jpg --pink\_grayskel , --pink\_grayskel[0] ,10 --pink\_grayskel[0] ,100 -append\_tiles 2}}
\end{center}
...
{\footnotesize \textbf{Example 593~:} \texttt{image.jpg --blur 2 --pink\_heightminima ,15 --pink\_heightmaxima[0,1] ,15 --[-3,-1] --[-3,-1] -k[-1,-2]}}
\end{center}
...
{\footnotesize \textbf{Example 594~:} \texttt{image.jpg --blur 2 --pink\_heightminima ,15 --pink\_heightmaxima[0,1] ,15 --[-3,-1] --[-3,-1] -k[-1,-2]}}
\end{center}
...
{\footnotesize \textbf{Example 595~:} \texttt{image.jpg --pink\_htkern ,u --pink\_htkern[0] , ---[-1,-2] -rm[0]}}
\end{center}
...
{\footnotesize \textbf{Example 596~:} \texttt{image.jpg -pink\_lvkern ,u}}
\end{center}
...
{\footnotesize \textbf{Example 597~:} \texttt{image.jpg --blur 2 -pink\_reg\_minima ,}}
\end{center}
...
{\footnotesize \textbf{Example 598~:} \texttt{image.jpg -threshold 50\% \{w\},\{h\} -fill[-1] 'if(x$>$w/2,255,0)' tp=@\{-path\_tmp\} -output[-1] \$\{tp\}/inhibit.pgm -remove[-1] --pink\_skelcurv[0] , --pink\_skelcurv[0] ,,\$\{tp\}/inhibit.pgm -exec "rm "\$\{tp\}"/inhibit.pgm"}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def599.jpg}\\
{\footnotesize \textbf{Example 599~:} \texttt{image.jpg -threshold 50\% --pink\_skelcurv , --pink\_skelcurv[-2] ,8}}
\end{center}
...
{\footnotesize \textbf{Example 600~:} \texttt{image.jpg -threshold 50\% --pink\_skelend , --pink\_skelend[-2] ,-1}}
\end{center}
...
{\footnotesize \textbf{Example 601~:} \texttt{image.jpg -threshold 50\% --pink\_skeleton[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 602~:} \texttt{image.jpg -threshold 50\% --pink\_skelpar[-1] 0 --pink\_skelpar[-1] 2}}
\end{center}
...
{\footnotesize \textbf{Example 603~:} \texttt{image.jpg --pink\_wshed ,1,5 -pink\_wshed[0] ,,5}}
\end{center}
...
{\footnotesize \textbf{Example 604~:} \texttt{image.jpg --luminance -quantize[-1] 2 -label[-1] 0,1 mean=@\{"-region\_feature[0,1] 10,\textbackslash "\{ia\}\textbackslash ""\} sum=@\{"-region\_feature[0,1] 10,\textbackslash "@\{-1,+\}\textbackslash ""\}}}
\end{center}
...
{\footnotesize \textbf{Example 605~:} \texttt{-gpt ,}}
\end{center}
