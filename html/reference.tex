...
\subsection{\emph{-apply\_parallel2\index{-apply\_parallel2}} }\vspace*{-0.5em}
~\\\textbf{Arguments: } 
...
\subsection{\emph{-apply\_parallel4\index{-apply\_parallel4}} }\vspace*{-0.5em}
~\\\textbf{Arguments: } 
{\small \texttt{overlap[\%],"command"}}\\~\\
...
\subsection{\emph{-apply\_parallel8\index{-apply\_parallel8}} }\vspace*{-0.5em}
~\\\textbf{Arguments: } 
{\small \texttt{overlap[\%],"command"}}\\~\\
