...
{\footnotesize \textbf{Example 399~:} \texttt{-repeat 10 a=\{\$$>$*2*pi/10\} -arrow3d 0,0,0,\{cos(\$a)\},\{sin(\$a)\},-0.5 -done -+3d}}
\end{center}
...
{\footnotesize \textbf{Example 408~:} \texttt{image.jpg -luminance -resize2dy 40 -threshold 50\% -* 255 -pointcloud3d -color3d[-1] 255,255,255 -cubes3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 409~:} \texttt{-cup3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 410~:} \texttt{-cylinder3d 10,40 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 411~:} \texttt{image.jpg -distribution3d -colorcube3d -primitives3d[-1] 1 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 412~:} \texttt{-torus3d 5,2 -repeat 5 --add3d[-1] 12,0,0 -div3d[-1] 1.2 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 413~:} \texttt{-mode3d 1 -repeat 2 -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -double3d \$$>$ -snapshot3d[-1] 400 -done}}
\end{center}
...
{\footnotesize \textbf{Example 414~:} \texttt{image.jpg -blur 5 -elevation3d 0.5}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def415.jpg}\\
{\footnotesize \textbf{Example 415~:} \texttt{128,128,1,3,?(255) -plasma 10,3 -blur 4 -sharpen 10000 -elevation3d[-1] 'X=(x-64)/6;Y=(y-64)/6;100*exp(-(X\textasciicircum 2+Y\textasciicircum 2)/30)*abs(cos(X)*sin(Y))'}}
\end{center}
...
{\footnotesize \textbf{Example 416~:} \texttt{-empty3d}}
\end{center}
...
{\footnotesize \textbf{Example 417~:} \texttt{image.jpg -threshold 50\% -extrude3d 16}}
\end{center}
...
{\footnotesize \textbf{Example 418~:} \texttt{-repeat 5 -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -focale3d \{\$$<$*90\} -snapshot3d[-1] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 419~:} \texttt{image.jpg -r2dy 32 -distribution3d -gaussians3d 20 -colorcube3d -primitives3d[-1] 1 -+3d}}
\end{center}
...
{\footnotesize \textbf{Example 420~:} \texttt{-gmic3d --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 421~:} \texttt{-gyroid3d 48 --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 422~:} \texttt{image.jpg -histogram3d -colorcube3d -primitives3d[-1] 1 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 423~:} \texttt{image.jpg -animate flower,"30,0","30,5",6 -image6cube3d}}
\end{center}
...
{\footnotesize \textbf{Example 424~:} \texttt{image.jpg -imagecube3d}}
\end{center}
...
{\footnotesize \textbf{Example 425~:} \texttt{image.jpg -imageplane3d}}
\end{center}
...
{\footnotesize \textbf{Example 426~:} \texttt{image.jpg -imagepyramid3d}}
\end{center}
...
{\footnotesize \textbf{Example 427~:} \texttt{image.jpg -imagerubik3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 428~:} \texttt{image.jpg -imagesphere3d 32,16}}
\end{center}
...
{\footnotesize \textbf{Example 429~:} \texttt{image.jpg -blur 1 -isoline3d 50\%}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def430.jpg}\\
{\footnotesize \textbf{Example 430~:} \texttt{-isoline3d 'X=x-w/2;Y=y-h/2;(X\textasciicircum 2+Y\textasciicircum 2)\%20',10,-10,-10,10,10}}
\end{center}
...
{\footnotesize \textbf{Example 431~:} \texttt{image.jpg -resize2dy 128 -luminance -threshold 50\% -expand\_z 2,0 -blur 1 -isosurface3d 50\% -mul3d 1,1,30}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def432.jpg}\\
{\footnotesize \textbf{Example 432~:} \texttt{-isosurface3d 'x\textasciicircum 2+y\textasciicircum 2+abs(z)\textasciicircum abs(4*cos(x*y*z*3))',3}}
\end{center}
...
{\footnotesize \textbf{Example 433~:} \texttt{-torus3d 100,40,6,6 -label\_points3d 24,1 -mode3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 434~:} \texttt{300,300 -rand -1,1 -blur 40 -sign -normalize 0,255 -lathe3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 435~:} \texttt{-torus3d 100,30 -double3d 0 -specs3d 1.2 -repeat 5 -light3d \{\$$>$*100\},0,-300 --snapshot3d[0] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 436~:} \texttt{-repeat 100 a=\{\$$>$*pi/50\} -line3d 0,0,0,\{cos(3*\$a)\},\{sin(2*\$a)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 437~:} \texttt{-lissajous3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 438~:} \texttt{(0,1,2,3,4,5) -double3d 0 -repeat \{w\} -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -mode3d @\{0,\$$>$\} -snapshot3d[-1] 300 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 439~:} \texttt{-torus3d 5,2 -repeat 5 --add3d[-1] 10,0,0 -mul3d[-1] 1.2 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 440~:} \texttt{-repeat 100 -circle3d \{?(3)\},\{?(3)\},\{?(3)\},0.1 -done -add3d -color3d[-1] 255,0,0 --normalize3d[-1] -color3d[-1] 0,255,0 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 441~:} \texttt{-torus3d 100,10 -double3d 0 -repeat 7 --rotate3d[-1] 1,0,0,20 -opacity3d[-1] \{?\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 442~:} \texttt{-parametric3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 443~:} \texttt{image.jpg -pca\_patch3d 7}}
\end{center}
...
{\footnotesize \textbf{Example 444~:} \texttt{-plane3d 50,30 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 445~:} \texttt{-repeat 1000 a=\{\$$>$*pi/500\} -point3d \{cos(3*\$a)\},\{sin(2*\$a)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 446~:} \texttt{image.jpg -luminance -resize2dy 100 -threshold 50\% -* 255 -pointcloud3d -color3d[-1] 255,255,255}}
\end{center}
...
{\footnotesize \textbf{Example 447~:} \texttt{-sphere3d 30 -primitives3d 1 -torus3d 50,10 -color3d[-1] @\{-RGB\} -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 448~:} \texttt{-pyramid3d 100,100 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 449~:} \texttt{-quadrangle3d -10,-10,10,10,-10,10,10,10,10,-10,10,10 -repeat 10 --rotate3d[-1] 0,1,0,30 -color3d[-1] @\{-RGB\},0.6 -done -add3d -mode3d 2}}
\end{center}
...
{\footnotesize \textbf{Example 450~:} \texttt{-torus3d 100,40 -double3d 0 --reverse3d}}
\end{center}
...
{\footnotesize \textbf{Example 451~:} \texttt{-torus3d 100,10 -double3d 0 -repeat 7 --rotate3d[-1] 1,0,0,20 -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 452~:} \texttt{-rotation3d 1,0,0,0 -rotation3d 1,0,0,90 -rotation3d 1,0,0,180}}
\end{center}
...
{\footnotesize \textbf{Example 453~:} \texttt{-sierpinski3d 3 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 454~:} \texttt{-torus3d 100,20 -snapshot3d 400,1.2,128,64,32}}
\end{center}
...
{\footnotesize \textbf{Example 455~:} \texttt{(0,0.3,0.6,0.9,1.2) -repeat \{w\} -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -color3d[-1] 255,0,0 -specl3d @\{0,\$$>$\} -snapshot3d[-1] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 456~:} \texttt{(0,0.3,0.6,0.9,1.2) -repeat \{w\} -torus3d 100,30 -rotate3d[-1] 1,1,0,60 -color3d[-1] 255,0,0 -specs3d @\{0,\$$>$\} -snapshot3d[-1] 400 -done -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 457~:} \texttt{-sphere3d 100 --primitives3d 1  -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 458~:} \texttt{-spherical3d 64 --primitives3d 1}}
\end{center}
...
{\footnotesize \textbf{Example 459~:} \texttt{-repeat 100 -spline3d \{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},\{?\},128 -color3d[-1] @\{-RGB\} -done -box3d 1 -primitives3d[-1] 1 -+3d}}
\end{center}
...
{\footnotesize \textbf{Example 460~:} \texttt{-box3d 100 --split3d}}
\end{center}
...
{\footnotesize \textbf{Example 461~:} \texttt{image.jpg -sprite3d}}
\end{center}
...
{\footnotesize \textbf{Example 462~:} \texttt{-torus3d 100,20 image.jpg -resize2dy[-1] 64 100\%,100\% -gaussian[-1] 30\%,30\% -*[-1] 255 -append[-2,-1] c --sprites3d -drgba[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 463~:} \texttt{-star3d , --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 464~:} \texttt{100,100,100,3 -rand -10,10 -blur 3 -repeat 300 --streamline3d[0] \{?(100)\},\{?(100)\},\{?(100)\},1000,1,1 -color3d[-1] @\{-RGB\} -done -rm[0] -box3d 100 -primitives3d[-1] 1 -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 465~:} \texttt{-sphere3d 10 -repeat 5 --sub3d[-1] 10,\{?(-10,10)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 466~:} \texttt{-superformula3d ,}}
\end{center}
...
{\footnotesize \textbf{Example 467~:} \texttt{-text\_pointcloud3d "G'MIC","Rocks!"}}
\end{center}
...
{\footnotesize \textbf{Example 468~:} \texttt{-text3d "G'MIC as a\textbackslash n3D logo!"}}
\end{center}
...
{\footnotesize \textbf{Example 469~:} \texttt{image.jpg -torus3d 100,30 -texturize3d[-1] [-2] -keep[-1]}}
\end{center}
...
{\footnotesize \textbf{Example 470~:} \texttt{-torus3d 10,3 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 471~:} \texttt{-repeat 100 a=\{\$$>$*pi/50\} -triangle3d 0,0,0,0,0,3,\{cos(3*\$a)\},\{sin(2*\$a)\},0 -color3d[-1] @\{-RGB\} -done -add3d}}
\end{center}
...
{\footnotesize \textbf{Example 472~:} \texttt{image.jpg -animate blur,0,5,30 -a z -volume3d}}
\end{center}
...
{\footnotesize \textbf{Example 473~:} \texttt{-weird3d 48 --primitives3d 1 -color3d[-2] @\{-RGB\}}}
\end{center}
...
{\footnotesize \textbf{Example 474~:} \texttt{image.jpg --mirror x --mirror y -apply\_parallel "-blur 3"}}
\end{center}
...
{\footnotesize \textbf{Example 475~:} \texttt{image.jpg -apply\_parallel\_channels "-blur 3"}}
\end{center}
...
{\footnotesize \textbf{Example 476~:} \texttt{image.jpg --apply\_parallel\_overlap "-smooth 500,0,1",16}}
\end{center}
...
{\footnotesize \textbf{Example 594~:} \texttt{image.jpg --luminance -quantize[-1] 2 -label[-1] 0,1 mean=@\{"-region\_feature[0,1] 10,\textbackslash "\{ia\}\textbackslash ""\} sum=@\{"-region\_feature[0,1] 10,\textbackslash "@\{-1,+\}\textbackslash ""\}}}
\end{center}
...
{\footnotesize \textbf{Example 595~:} \texttt{-gpt ,}}
\end{center}
