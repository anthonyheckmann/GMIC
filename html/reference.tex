...
{\footnotesize \textbf{Example 124~:} \texttt{image.jpg --histogram 256 --cumul[-1] -display\_graph[-2,-1] 400,300,3}}
\end{center}
...
{\footnotesize \textbf{Example 128~:} \texttt{image.jpg --equalize 256}}
...
{\footnotesize \textbf{Example 145~:} \texttt{image.jpg --histogram[-1] 256 -normalize\_sum[-1] -display\_graph[-1] 400,300}}
\end{center}
...
{\footnotesize \textbf{Example 163~:} \texttt{image.jpg --apply\_channels "-equalize 256 -blur 2",5}}
\end{center}
...
{\footnotesize \textbf{Example 169~:} \texttt{image.jpg --equalize 256 -ditheredbw[-1]}}
\end{center}
...
{\footnotesize \textbf{Example 171~:} \texttt{image.jpg --gradient2rgb 0 -equalize[-1] 256}}
\end{center}
...
{\footnotesize \textbf{Example 288~:} \texttt{image.jpg --gradient\_norm -equalize[-1] 256}}
\end{center}
...
{\footnotesize \textbf{Example 326~:} \texttt{400,400 -noise 0.2,2 --distance 1 -mul[-1] -1 -label[-2] 0 -watershed[-2] [-1] -mod[-2] 256 -map[-2] 0 -reverse}}
\end{center}
...
{\footnotesize \textbf{Example 339~:} \texttt{image.jpg -luminance -threshold 60\% -label 0 -normalize 0,255 -map 0}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def340.jpg}\\
{\footnotesize \textbf{Example 340~:} \texttt{400,400 -set 1,50\%,50\% -distance 1 -mod 16 -threshold 8 -label 0 -mod 255 -map 2}}
\end{center}
...
{\footnotesize \textbf{Example 357~:} \texttt{32,32 64,64 200,200 256,256 -ball 255,164,100}}
\end{center}
...
{\footnotesize \textbf{Example 376~:} \texttt{400,400,1,3 -plasma 1}}
\end{center}
...
{\footnotesize \textbf{Example 537~:} \texttt{image.jpg --poster\_edges ,}}
\end{center}
...
{\footnotesize \textbf{Example 538~:} \texttt{image.jpg --poster\_hope ,}}
\end{center}
...
{\footnotesize \textbf{Example 539~:} \texttt{image.jpg --rodilius 12,10,300,10 -normalize\_local[-1] 10,6}}
\end{center}
...
{\footnotesize \textbf{Example 540~:} \texttt{image.jpg --stained\_glass ,}}
\end{center}
...
{\footnotesize \textbf{Example 541~:} \texttt{image.jpg -stars ,}}
\end{center}
...
{\footnotesize \textbf{Example 542~:} \texttt{image.jpg --sketchbw 1 --local -reverse -blur[-1] 3 -blend overlay -endl}}
\end{center}
...
{\footnotesize \textbf{Example 543~:} \texttt{image.jpg --sponge ,}}
\end{center}
...
{\footnotesize \textbf{Example 544~:} \texttt{image.jpg --stencil 1,10,3}}
\end{center}
...
{\footnotesize \textbf{Example 545~:} \texttt{image.jpg --stencilbw 40,4}}
\end{center}
...
{\footnotesize \textbf{Example 546~:} \texttt{image.jpg --tetris 10}}
\end{center}
...
{\footnotesize \textbf{Example 547~:} \texttt{image.jpg --warhol 5,3,3,40}}
\end{center}
...
{\footnotesize \textbf{Example 548~:} \texttt{image.jpg --weave ,}}
\end{center}
...
{\footnotesize \textbf{Example 549~:} \texttt{image.jpg --whirls ,}}
\end{center}
\section{Warpings}
...
{\footnotesize \textbf{Example 550~:} \texttt{image.jpg --euclidean2polar ,}}
\end{center}
...
{\footnotesize \textbf{Example 551~:} \texttt{image.jpg --deform[0] 10 --deform[0] 20}}
\end{center}
...
{\footnotesize \textbf{Example 552~:} \texttt{image.jpg --fisheye ,}}
\end{center}
...
{\footnotesize \textbf{Example 553~:} \texttt{image.jpg -flower ,}}
\end{center}
...
{\footnotesize \textbf{Example 554~:} \texttt{image.jpg --kaleidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 555~:} \texttt{image.jpg --map\_sphere ,}}
\end{center}
...
{\footnotesize \textbf{Example 556~:} \texttt{image.jpg --euclidean2polar , -mirror[-1] x -polar2euclidean[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 557~:} \texttt{image.jpg --raindrops ,}}
\end{center}
...
{\footnotesize \textbf{Example 558~:} \texttt{image.jpg --ripple ,}}
\end{center}
...
{\footnotesize \textbf{Example 559~:} \texttt{image.jpg --rotoidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 560~:} \texttt{image.jpg --symmetrize 50\%,50\%,45 --symmetrize[-1] 50\%,50\%,-45}}
\end{center}
...
{\footnotesize \textbf{Example 561~:} \texttt{image.jpg --transform\_polar[0] R*(r/R)\textasciicircum 2,a --transform\_polar[0] r,2*a}}
\end{center}
...
{\footnotesize \textbf{Example 562~:} \texttt{image.jpg --twirl 0.6}}
\end{center}
...
{\footnotesize \textbf{Example 563~:} \texttt{image.jpg --warp\_perspective ,}}
\end{center}
...
{\footnotesize \textbf{Example 564~:} \texttt{image.jpg --water ,}}
\end{center}
...
{\footnotesize \textbf{Example 565~:} \texttt{image.jpg --wave ,}}
\end{center}
...
{\footnotesize \textbf{Example 566~:} \texttt{image.jpg --wind ,}}
\end{center}
...
{\footnotesize \textbf{Example 567~:} \texttt{image.jpg --zoom[0] 0.6 --zoom[0] 1.5}}
\end{center}
...
{\footnotesize \textbf{Example 568~:} \texttt{image.jpg --cracks 0.2,60,1}}
\end{center}
...
{\footnotesize \textbf{Example 569~:} \texttt{image.jpg --light\_patch 20,0.9,4}}
\end{center}
...
{\footnotesize \textbf{Example 570~:} \texttt{image.jpg --noise\_hurl ,}}
\end{center}
...
{\footnotesize \textbf{Example 571~:} \texttt{image.jpg --pixelize ,}}
\end{center}
...
{\footnotesize \textbf{Example 572~:} \texttt{image.jpg --shade\_stripes 30}}
\end{center}
...
{\footnotesize \textbf{Example 573~:} \texttt{image.jpg --shadow\_patch 0.4}}
\end{center}
...
{\footnotesize \textbf{Example 574~:} \texttt{image.jpg --spread 3}}
\end{center}
...
{\footnotesize \textbf{Example 575~:} \texttt{image.jpg --stripes\_y ,}}
\end{center}
...
{\footnotesize \textbf{Example 576~:} \texttt{image.jpg --texturize\_canvas ,}}
\end{center}
...
{\footnotesize \textbf{Example 577~:} \texttt{image.jpg --texturize\_paper}}
\end{center}
...
{\footnotesize \textbf{Example 578~:} \texttt{image.jpg --vignette ,}}
\end{center}
...
{\footnotesize \textbf{Example 579~:} \texttt{image.jpg --watermark\_visible ,0.7}}
\end{center}
...
{\footnotesize \textbf{Example 580~:} \texttt{image.jpg --drop\_shadow , -resize2dy[-1] 200 -rotate[-1] 20 --blend alpha -drgba[-2]}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def581.jpg}\\
{\footnotesize \textbf{Example 581~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -blend overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def582.jpg}\\
{\footnotesize \textbf{Example 582~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex add,alpha,and,average,blue,burn,darken}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def583.jpg}\\
{\footnotesize \textbf{Example 583~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex difference,divide,dodge,exclusion,freeze,grainextract,grainmerge}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def584.jpg}\\
{\footnotesize \textbf{Example 584~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex green,hardlight,hardmix,hue,interpolation,lighten,lightness}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def585.jpg}\\
{\footnotesize \textbf{Example 585~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex linearburn,linearlight,luminance,multiply,negation,or,overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def586.jpg}\\
{\footnotesize \textbf{Example 586~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex pinlight,red,reflect,saturation,screen,shapeaverage,softburn}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def587.jpg}\\
{\footnotesize \textbf{Example 587~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex softdodge,softlight,stamp,subtract,value,vividlight,xor}}
\end{center}
...
{\footnotesize \textbf{Example 588~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --blend\_edges 0.8}}
\end{center}
...
{\footnotesize \textbf{Example 589~:} \texttt{image.jpg -testimage2d \{w\},\{h\} 100\%,100\%,1,1,'cos(y/10)' -normalize[-1] 0,1 --blend\_fade}}
\end{center}
...
{\footnotesize \textbf{Example 590~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --mirror[0] y --blend\_median}}
\end{center}
...
{\footnotesize \textbf{Example 591~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_diamond 80,85}}
\end{center}
...
{\footnotesize \textbf{Example 592~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_linear 45,48,52}}
\end{center}
...
{\footnotesize \textbf{Example 593~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_radial 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 594~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_x 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 595~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_y 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 596~:} \texttt{image.jpg -animate flower,"0,3","20,8",9}}
\end{center}
...
{\footnotesize \textbf{Example 597~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% -morph 9}}
\end{center}
...
{\footnotesize \textbf{Example 598~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% --register\_nonrigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 599~:} \texttt{image.jpg --shift 30,20 --register\_rigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 600~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -transition\_plasma 9}}
\end{center}
...
{\footnotesize \textbf{Example 601~:} \texttt{image.jpg --blur 5 -transition3d 9 -drgba}}
\end{center}
...
{\footnotesize \textbf{Example 602~:} \texttt{image.jpg --pink asfr,5 -pink[0] asf,5}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def603.jpg}\\
{\footnotesize \textbf{Example 603~:} \texttt{image.jpg --blur 2 -pink maxima,4}}
\end{center}
...
{\footnotesize \textbf{Example 604~:} \texttt{image.jpg --pink\_grayskel , --pink\_grayskel[0] ,10 --pink\_grayskel[0] ,100 -append\_tiles 2}}
\end{center}
...
{\footnotesize \textbf{Example 605~:} \texttt{image.jpg --blur 2 --pink\_heightminima ,15 --pink\_heightmaxima[0,1] ,15 --[-3,-1] --[-3,-1] -k[-1,-2]}}
\end{center}
...
{\footnotesize \textbf{Example 607~:} \texttt{image.jpg --pink\_htkern ,u --pink\_htkern[0] , ---[-1,-2] -rm[0]}}
\end{center}
...
{\footnotesize \textbf{Example 608~:} \texttt{image.jpg -pink\_lvkern ,u}}
\end{center}
...
{\footnotesize \textbf{Example 609~:} \texttt{image.jpg --blur 2 -pink\_reg\_minima ,}}
\end{center}
...
{\footnotesize \textbf{Example 610~:} \texttt{image.jpg -threshold 50\% \{w\},\{h\} -fill[-1] 'if(x$>$w/2,255,0)' tp=@\{-path\_tmp\} -output[-1] \$\{tp\}/inhibit.pgm -remove[-1] --pink\_skelcurv[0] , --pink\_skelcurv[0] ,,\$\{tp\}/inhibit.pgm -exec "rm "\$\{tp\}"/inhibit.pgm"}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def611.jpg}\\
{\footnotesize \textbf{Example 611~:} \texttt{image.jpg -threshold 50\% --pink\_skelcurv , --pink\_skelcurv[-2] ,8}}
\end{center}
...
{\footnotesize \textbf{Example 612~:} \texttt{image.jpg -threshold 50\% --pink\_skelend , --pink\_skelend[-2] ,-1}}
\end{center}
...
{\footnotesize \textbf{Example 613~:} \texttt{image.jpg -threshold 50\% --pink\_skeleton[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 614~:} \texttt{image.jpg -threshold 50\% --pink\_skelpar[-1] 0 --pink\_skelpar[-1] 2}}
\end{center}
...
{\footnotesize \textbf{Example 615~:} \texttt{image.jpg --pink\_wshed ,1,5 -pink\_wshed[0] ,,5}}
\end{center}
...
{\footnotesize \textbf{Example 616~:} \texttt{image.jpg --luminance -quantize[-1] 2 -label[-1] 0,1 mean=@\{"-region\_feature[0,1] 10,\textbackslash "\{ia\}\textbackslash ""\} sum=@\{"-region\_feature[0,1] 10,\textbackslash "@\{-1,+\}\textbackslash ""\}}}
\end{center}
...
{\footnotesize \textbf{Example 617~:} \texttt{-gpt ,}}
\end{center}
