...
\sloppy{} 
\title{\fbox{\parbox{\textwidth}{\begin{center}\vspace*{2cm}\includegraphics[width=12cm]{logo3.jpg}\\\vspace*{1cm}{\Huge \textbf{The Handbook}\\{\small Version 1.5.8.1}\\\vspace*{1cm}}\end{center}}}} 
...
\section*{Version} 
 ...
 gmic: GREYC's Magic for Image Computing. 
        ...
        Version 1.5.8.1, Copyright (c) 2008-2013, David Tschumperl\'e 
...
{\footnotesize \textbf{Example 511~:} \texttt{image.jpg --quadratize\_tiles 16}}
\end{center}
...
{\footnotesize \textbf{Example 512~:} \texttt{image.jpg -to\_rgba -rotate\_tiles 10,8 -drop\_shadow 10,10 -display\_rgba}}
\end{center}
...
{\footnotesize \textbf{Example 513~:} \texttt{image.jpg --shift\_tiles 8,8,10}}
\end{center}
...
{\footnotesize \textbf{Example 514~:} \texttt{image.jpg --taquin 8}}
\end{center}
...
{\footnotesize \textbf{Example 515~:} \texttt{image.jpg --tunnel 20}}
\end{center}
\section{Artistic}
...
{\footnotesize \textbf{Example 516~:} \texttt{image.jpg --boxfitting ,}}
\end{center}
...
{\footnotesize \textbf{Example 517~:} \texttt{image.jpg --cartoon 3,80,15}}
\end{center}
...
{\footnotesize \textbf{Example 518~:} \texttt{image.jpg --circlism ,}}
\end{center}
...
{\footnotesize \textbf{Example 519~:} \texttt{image.jpg --color\_ellipses ,,0.15}}
\end{center}
...
{\footnotesize \textbf{Example 520~:} \texttt{image.jpg --cubism ,}}
\end{center}
...
{\footnotesize \textbf{Example 521~:} \texttt{image.jpg --dotsbw , --blend shapeaverage0}}
\end{center}
...
{\footnotesize \textbf{Example 543~:} \texttt{image.jpg -stars ,}}
\end{center}
...
{\footnotesize \textbf{Example 544~:} \texttt{image.jpg --sketchbw 1 --local -reverse -blur[-1] 3 -blend overlay -endlocal}}
\end{center}
...
{\footnotesize \textbf{Example 545~:} \texttt{image.jpg --sponge ,}}
\end{center}
...
{\footnotesize \textbf{Example 546~:} \texttt{image.jpg --stencil 1,10,3}}
\end{center}
...
{\footnotesize \textbf{Example 547~:} \texttt{image.jpg --stencilbw 40,4}}
\end{center}
...
{\footnotesize \textbf{Example 548~:} \texttt{image.jpg --tetris 10}}
\end{center}
...
{\footnotesize \textbf{Example 549~:} \texttt{image.jpg --warhol 5,3,3,40}}
\end{center}
...
{\footnotesize \textbf{Example 550~:} \texttt{image.jpg --weave ,}}
\end{center}
...
{\footnotesize \textbf{Example 551~:} \texttt{image.jpg --whirls ,}}
\end{center}
\section{Warpings}
...
{\footnotesize \textbf{Example 552~:} \texttt{image.jpg --euclidean2polar ,}}
\end{center}
...
{\footnotesize \textbf{Example 553~:} \texttt{image.jpg --deform[0] 10 --deform[0] 20}}
\end{center}
...
{\footnotesize \textbf{Example 554~:} \texttt{image.jpg --fisheye ,}}
\end{center}
...
{\footnotesize \textbf{Example 555~:} \texttt{image.jpg -flower ,}}
\end{center}
...
{\footnotesize \textbf{Example 556~:} \texttt{image.jpg --kaleidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 557~:} \texttt{image.jpg --map\_sphere ,}}
\end{center}
...
{\footnotesize \textbf{Example 558~:} \texttt{image.jpg --euclidean2polar , -mirror[-1] x -polar2euclidean[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 559~:} \texttt{image.jpg --raindrops ,}}
\end{center}
...
{\footnotesize \textbf{Example 560~:} \texttt{image.jpg --ripple ,}}
\end{center}
...
{\footnotesize \textbf{Example 561~:} \texttt{image.jpg --rotoidoscope ,}}
\end{center}
...
{\footnotesize \textbf{Example 562~:} \texttt{image.jpg --symmetrize 50\%,50\%,45 --symmetrize[-1] 50\%,50\%,-45}}
\end{center}
...
{\footnotesize \textbf{Example 563~:} \texttt{image.jpg --transform\_polar[0] R*(r/R)\textasciicircum 2,a --transform\_polar[0] r,2*a}}
\end{center}
...
{\footnotesize \textbf{Example 564~:} \texttt{image.jpg --twirl 0.6}}
\end{center}
...
{\footnotesize \textbf{Example 565~:} \texttt{image.jpg --warp\_perspective ,}}
\end{center}
...
{\footnotesize \textbf{Example 566~:} \texttt{image.jpg --water ,}}
\end{center}
...
{\footnotesize \textbf{Example 567~:} \texttt{image.jpg --wave ,}}
\end{center}
...
{\footnotesize \textbf{Example 568~:} \texttt{image.jpg --wind ,}}
\end{center}
...
{\footnotesize \textbf{Example 569~:} \texttt{image.jpg --zoom[0] 0.6 --zoom[0] 1.5}}
\end{center}
...
{\footnotesize \textbf{Example 570~:} \texttt{image.jpg --cracks 0.2,60,1}}
\end{center}
...
{\footnotesize \textbf{Example 571~:} \texttt{image.jpg --light\_patch 20,0.9,4}}
\end{center}
...
{\footnotesize \textbf{Example 572~:} \texttt{image.jpg --noise\_hurl ,}}
\end{center}
...
{\footnotesize \textbf{Example 573~:} \texttt{image.jpg --pixelize ,}}
\end{center}
...
{\footnotesize \textbf{Example 574~:} \texttt{image.jpg --shade\_stripes 30}}
\end{center}
...
{\footnotesize \textbf{Example 575~:} \texttt{image.jpg --shadow\_patch 0.4}}
\end{center}
...
{\footnotesize \textbf{Example 576~:} \texttt{image.jpg --spread 3}}
\end{center}
...
{\footnotesize \textbf{Example 577~:} \texttt{image.jpg --stripes\_y ,}}
\end{center}
...
{\footnotesize \textbf{Example 578~:} \texttt{image.jpg --texturize\_canvas ,}}
\end{center}
...
{\footnotesize \textbf{Example 579~:} \texttt{image.jpg --texturize\_paper}}
\end{center}
...
{\footnotesize \textbf{Example 580~:} \texttt{image.jpg --vignette ,}}
\end{center}
...
{\footnotesize \textbf{Example 581~:} \texttt{image.jpg --watermark\_visible ,0.7}}
\end{center}
...
{\footnotesize \textbf{Example 582~:} \texttt{image.jpg --drop\_shadow , -resize2dy[-1] 200 -rotate[-1] 20 --blend alpha -drgba[-2]}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def583.jpg}\\
{\footnotesize \textbf{Example 583~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -blend overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def584.jpg}\\
{\footnotesize \textbf{Example 584~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex add,alpha,and,average,blue,burn,darken}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def585.jpg}\\
{\footnotesize \textbf{Example 585~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex difference,divide,dodge,exclusion,freeze,grainextract,grainmerge}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def586.jpg}\\
{\footnotesize \textbf{Example 586~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex green,hardlight,hardmix,hue,interpolation,lighten,lightness}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def587.jpg}\\
{\footnotesize \textbf{Example 587~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex linearburn,linearlight,luminance,multiply,negation,or,overlay}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def588.jpg}\\
{\footnotesize \textbf{Example 588~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex pinlight,red,reflect,saturation,screen,shapeaverage,softburn}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def589.jpg}\\
{\footnotesize \textbf{Example 589~:} \texttt{-m "ex : \$""=arg -repeat \$""\% --blend[0,1] \$\{arg\{\$$>$+1\}\} -text\_outline[-1] Mode:\textbackslash " \textbackslash "\$\{arg\{\$$>$+1\}\},2,2,24,2,1,255 -done" image.jpg -testimage2d \{w\},\{h\} -ex softdodge,softlight,stamp,subtract,value,vividlight,xor}}
\end{center}
...
{\footnotesize \textbf{Example 590~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --blend\_edges 0.8}}
\end{center}
...
{\footnotesize \textbf{Example 591~:} \texttt{image.jpg -testimage2d \{w\},\{h\} 100\%,100\%,1,1,'cos(y/10)' -normalize[-1] 0,1 --blend\_fade}}
\end{center}
...
{\footnotesize \textbf{Example 592~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --mirror[0] y --blend\_median}}
\end{center}
...
{\footnotesize \textbf{Example 593~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_diamond 80,85}}
\end{center}
...
{\footnotesize \textbf{Example 594~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_linear 45,48,52}}
\end{center}
...
{\footnotesize \textbf{Example 595~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_radial 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 596~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_x 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 597~:} \texttt{image.jpg -testimage2d \{w\},\{h\} --fade\_y 30,70}}
\end{center}
...
{\footnotesize \textbf{Example 598~:} \texttt{image.jpg -animate flower,"0,3","20,8",9}}
\end{center}
...
{\footnotesize \textbf{Example 599~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% -morph 9}}
\end{center}
...
{\footnotesize \textbf{Example 600~:} \texttt{image.jpg --rotate 20,1,1,50\%,50\% --register\_nonrigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 601~:} \texttt{image.jpg --shift 30,20 --register\_rigid , -remove[-2]}}
\end{center}
...
{\footnotesize \textbf{Example 602~:} \texttt{image.jpg -testimage2d \{w\},\{h\} -transition\_plasma 9}}
\end{center}
...
{\footnotesize \textbf{Example 603~:} \texttt{image.jpg --blur 5 -transition3d 9 -drgba}}
\end{center}
...
{\footnotesize \textbf{Example 604~:} \texttt{image.jpg --pink asfr,5 -pink[0] asf,5}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def605.jpg}\\
{\footnotesize \textbf{Example 605~:} \texttt{image.jpg --blur 2 -pink maxima,4}}
\end{center}
...
{\footnotesize \textbf{Example 606~:} \texttt{image.jpg --pink\_grayskel , --pink\_grayskel[0] ,10 --pink\_grayskel[0] ,100 -append\_tiles 2}}
\end{center}
...
{\footnotesize \textbf{Example 607~:} \texttt{image.jpg --blur 2 --pink\_heightminima ,15 --pink\_heightmaxima[0,1] ,15 --[-3,-1] --[-3,-1] -keep[-1,-2]}}
\end{center}
...
{\footnotesize \textbf{Example 609~:} \texttt{image.jpg --pink\_htkern ,u --pink\_htkern[0] , ---[-1,-2] -remove[0]}}
\end{center}
...
{\footnotesize \textbf{Example 610~:} \texttt{image.jpg -pink\_lvkern ,u}}
\end{center}
...
{\footnotesize \textbf{Example 611~:} \texttt{image.jpg --blur 2 -pink\_reg\_minima ,}}
\end{center}
...
{\footnotesize \textbf{Example 612~:} \texttt{image.jpg -threshold 50\% \{w\},\{h\} -fill[-1] 'if(x$>$w/2,255,0)' tp=@\{-path\_tmp\} -output[-1] \$\{tp\}/inhibit.pgm -remove[-1] --pink\_skelcurv[0] , --pink\_skelcurv[0] ,,\$\{tp\}/inhibit.pgm -exec "rm "\$\{tp\}"/inhibit.pgm"}}
\\\includegraphics[keepaspectratio=true,height=7cm,width=\textwidth]{img/gmic_def613.jpg}\\
{\footnotesize \textbf{Example 613~:} \texttt{image.jpg -threshold 50\% --pink\_skelcurv , --pink\_skelcurv[-2] ,8}}
\end{center}
...
{\footnotesize \textbf{Example 614~:} \texttt{image.jpg -threshold 50\% --pink\_skelend , --pink\_skelend[-2] ,-1}}
\end{center}
...
{\footnotesize \textbf{Example 615~:} \texttt{image.jpg -threshold 50\% --pink\_skeleton[-1] ,}}
\end{center}
...
{\footnotesize \textbf{Example 616~:} \texttt{image.jpg -threshold 50\% --pink\_skelpar[-1] 0 --pink\_skelpar[-1] 2}}
\end{center}
...
{\footnotesize \textbf{Example 617~:} \texttt{image.jpg --pink\_wshed ,1,5 -pink\_wshed[0] ,,5}}
\end{center}
...
{\footnotesize \textbf{Example 618~:} \texttt{image.jpg --luminance -quantize[-1] 2 -label[-1] 0,1 mean=@\{"-region\_feature[0,1] 10,\textbackslash "\{ia\}\textbackslash ""\} sum=@\{"-region\_feature[0,1] 10,\textbackslash "@\{-1,+\}\textbackslash ""\}}}
\end{center}
...
{\footnotesize \textbf{Example 619~:} \texttt{-gpt ,}}
\end{center}
